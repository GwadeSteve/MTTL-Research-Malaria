...
\usepackage{tabularx}
% Define a centered X column type
...
% Increase the width reserved for numbers
...
% Add a small vertical space between bibliography entries
\setlength\bibitemsep{0.1em} 

% Remove hanging indentation in bibliography
\setlength{\bibhang}{1em}

% Optional: italicize journal titles
...
\makeatletter
% Disable TOC writing for unnumbered chapters
\patchcmd{\@chapter}{\addcontentsline{toc}{chapter}{#1}}{}{}{}

% Disable TOC writing for unnumbered sections
\patchcmd{\@section}{\addcontentsline{toc}{section}{#1}}{}{}{}

% Disable TOC writing for unnumbered subsections
\patchcmd{\@subsection}{\addcontentsline{toc}{subsection}{#1}}{}{}{}

% Disable TOC writing for unnumbered subsubsections
\patchcmd{\@subsubsection}{\addcontentsline{toc}{subsubsection}{#1}}{}{}{}
\makeatother

%\usepackage{pagecolor}
%\definecolor{mybg}{RGB}{20, 20, 20}
%\definecolor{mytext}{RGB}{230, 230, 230}
...
% --- FRONT MATTER (TOC, LISTS, ETC.) ---
\pagestyle{fancy} % Apply fancy header/footer style
\pagenumbering{roman} % Use Roman numerals for the front matter (i, ii, iii)
...
\begingroup
\normalsize
% adjust number width and spacing
\setlength{\cftfignumwidth}{2.5em}      % space for numbers
\setlength{\cftfigindent}{0pt}          % remove indentation
\setlength{\cftbeforefigskip}{0pt}      % spacing before first figure
\setlength{\cftaftertoctitleskip}{0pt}  % spacing after title
% Prevent automatic title from appearing
...
\vspace*{-2.5cm}  % adjust to match chapter style
\begingroup
\normalsize
\setlength{\cfttabnumwidth}{2.5em}       % space for numbers
\setlength{\cfttabindent}{0pt}           % remove indentation
\setlength{\cftbeforetabskip}{0pt}       % spacing before first table
\setlength{\cftaftertoctitleskip}{0pt}   % spacing after title
\renewcommand{\listtablename}{}          % prevent automatic title
\listoftables
\endgroup
\cleardoublepage
...
\begingroup
\normalsize
\setlength{\cftmyequationsnumwidth}{2.5em}  % space for numbers
\setlength{\cftmyequationsindent}{0pt}      % remove indentation
\setlength{\cftbeforemyequationsskip}{0pt}  % spacing before first equation
\renewcommand{\listequationsname}{}         % prevent automatic title
\listofmyequations
\endgroup
\cleardoublepage
...
\pagenumbering{arabic} % Switch to Arabic numerals (1, 2, 3) for the main thesis body
\setcounter{page}{1}
