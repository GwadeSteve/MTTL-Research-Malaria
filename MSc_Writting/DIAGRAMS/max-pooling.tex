...
\begin{tikzpicture}[
    ...
    % Explicitly style the cells that are maximums within their windows
    % These will overlay the existing cell content with the styled node.
