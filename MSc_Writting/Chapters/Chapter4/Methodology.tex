...
\begin{figure}[htbp]
	...
	\vspace{1mm} % Adds a small vertical space between rows
...
\begin{figure}[t]
	...
	% Global setting for this figure to tighten caption spacing
	\captionsetup{skip=2pt, font=small} 
	
	% --- ROW 1: PREPROCESSED INPUT IMAGES ---
	% Slight reduction to 0.19\textwidth reduces height while keeping aspect ratio
	...
	% --- ROW 2: DETECTION GROUND TRUTH ---
	% Integrated title with minimal padding
	...
	% --- ROW 3: SEGMENTATION GROUND TRUTH ---
	...
	% --- ROW 4: LOCALIZATION GROUND TRUTH ---
...
\begin{figure}[htbp]
	...
	\scalebox{1.0}{%
		\begin{tikzpicture}[
			...
			% --- Create fork points for cleaner feature routing ---
			...
			% --- Draw main feature "trunks" from backbone and label them ---
			...
			% --- Connect forks to Detection Head (FPN) ---
			...
			% --- Connect forks to Segmentation Head ---
			...
			% --- Connect forks to Localization Head ---
