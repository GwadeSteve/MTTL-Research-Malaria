...
\begin{itemize}
	...
	\item The \textbf{RoI Classification} task forces a second feature extraction step on specific cell regions, refining the decision boundary between healthy and infected cells.
\end{itemize}
